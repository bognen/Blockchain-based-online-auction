...
const address = '0xc40Ec9ABd2c02038CD3140DE43d00d739E699F58';                             // Use very last entry of generated by Ganache
const privateKey = '04f35d0a6d5b7392094a20ff45413927a2476e20823658dd205363b9b15d7be5';    // Use very last entry of generated by Ganache
const infuraUrl = 'http://54.89.181.71:8545'                                                 // Taken from ganache
...
const init = async () => {
      ...
      let newContract = await mainContract.methods.createAuction("9821568", 1550, 1588, false, nowStamp, tomStamp).send({from: address}, (error, result) => {
          if (error) {
