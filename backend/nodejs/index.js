...
const address = '0x82D1D873a1c6aF36D7ECF65E284F7726FF04f27F';                             // Use very last entry of generated by Ganache
const privateKey = '422c0b3b4ef55ea869c94705b43827983282958d06ea69180be85855337b776b';    // Use very last entry of generated by Ganache
...
const init = async () => {
      ...
      let newContract = await mainContract.methods.createAuction(5000, 15, nowStamp, tomStamp).send({from: address}, (error, result) => {
          if (error) {
